...
export default function CheckoutPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // Redirecionar diretamente para o Stripe Checkout usando a URL
      if (url) {
  ...
  if (!currentPlan) {
    // Fallback para plano mensal se o plano selecionado não existir
            ...
            <div className="bg-[#C69A5B]/10 border border-[#C69A5B]/20 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="text-sm text-[#CFC8C4]">
                ...
                <p className="text-xs text-[#9A8F88]">
                  Processado via Stripe com criptografia de ponta. Seus dados estão protegidos.
                </p>
              </div>
            </div>
